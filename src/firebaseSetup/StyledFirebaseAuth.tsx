// Fork of react-firebaseui because of https://github.com/firebase/firebaseui-web-react/pull/173
...
export const StyledFirebaseAuth = ({uiConfig, firebaseAuth, className, uiCallback}: Props) => {
  ...
  useEffect(() => {
    ...
    const unregisterAuthObserver = firebaseAuth.onAuthStateChanged((user: firebase.User) => {
